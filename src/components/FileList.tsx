            ...
            >
              {editingFile === fileName ? (
                <input
                  ...
                  onKeyPress={(e) =>
                    e.key === "Enter" && handleRename(fileName)
                  }
                ...
                <a
                  ...
                  className="text-primary-light dark:text-primary-dark hover:underline truncate"
                >
                  {fileName}
                </a>
              )}
              <div className="flex space-x-2">
                ...
                >
                  {downloading[fileName] ? (
                    <svg
                      className="animate-spin h-5 w-5 text-primary-light dark:text-primary-dark"
